    ...
    <div className="relative">
      ...
      {showSettings && (
        <div className="absolute top-full mt-2 right-0 w-96 bg-slate-800 rounded-xl p-6 border-2 border-amber-500/40/30 shadow-2xl z-50">
          ...
          {/* Voice Selection */}
          <div className="mb-4">
            <label className="text-sm text-slate-300 font-semibold mb-2 block">Voice Style</label>
            <select
          ...
          <div className="mb-4">
            <div className="flex justify-between mb-2">
              <label className="text-sm text-slate-300 font-semibold">Speed</label>
          ...
          <div className="mb-4">
            <div className="flex justify-between mb-2">
              <label className="text-sm text-slate-300 font-semibold">Pitch</label>
          ...
          <div className="mb-4">
            <div className="flex justify-between mb-2">
              <label className="text-sm text-slate-300 font-semibold">Volume</label>
          ...
          <button
            ...
            className="w-full px-4 py-2 bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600 text-white rounded-lg font-semibold transition-all"
          >
            Test Voice
          </button>
        </div>
      ...
      <div className="mt-4 grid grid-cols-2 gap-2">
        {quickCommands.map((cmd) => (
          <button
            ...
            className="px-3 py-2 bg-slate-800 hover:bg-slate-700 text-white rounded-lg text-sm font-medium transition-all text-left"
          >
            {cmd.label}
          </button>
        ))}
