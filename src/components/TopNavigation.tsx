    ...
    <nav className="w-full flex items-center justify-between px-6 py-3 bg-gradient-to-r from-black via-stone-950 to-black backdrop-blur-xl shadow-2xl sticky top-0 z-50 border-b border-amber-500/30">
      ...
      <div className="hidden md:flex items-center gap-6 text-base font-semibold">
        ...
        <div className="relative" onMouseLeave={() => setEnterpriseMenuOpen(false)}>
          ...
          {enterpriseMenuOpen && (
            <div className="absolute top-full mt-2 right-0 min-w-[200px] bg-gradient-to-b from-amber-950 via-black to-yellow-950 border-2 border-amber-500/40 rounded-lg shadow-[0_0_30px_rgba(168,85,247,0.6)] z-50">
