...
const variantStyles: Record<ButtonVariant, string> = {
  primary: 'bg-gradient-to-br from-purple-900/50 to-blue-900/50 border-2 border-amber-600/40/40 hover:border-amber-400/40 hover:shadow-[0_0_20px_rgba(168,85,247,0.6)]',
  secondary: 'bg-gradient-to-br from-gray-900/50 to-gray-800/50 border-2 border-stone-700/40 hover:border-gray-400 hover:shadow-[0_0_20px_rgba(156,163,175,0.6)]',
  ...
  purple: 'bg-gradient-to-br from-purple-900/50 to-violet-900/50 border-2 border-amber-600/40/40 hover:border-amber-400/40 hover:shadow-[0_0_20px_rgba(168,85,247,0.6)]',
  blue: 'bg-gradient-to-br from-blue-900/50 to-cyan-900/50 border-2 border-amber-600/40/40 hover:border-blue-400 hover:shadow-[0_0_20px_rgba(59,130,246,0.6)]',
