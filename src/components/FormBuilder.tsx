  ...
  return (
    <div className="min-h-screen bg-[rgba(201,168,76,0.08)] p-8">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="bg-[#110F0B] rounded shadow-lg p-8 mb-6">
          <div className="flex justify-between items-start mb-6">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="px-6 py-3 bg-[rgba(201,168,76,0.04)] text-[#9E8F75] rounded-lg hover:bg-[rgba(201,168,76,0.08)] flex items-center gap-2"
              >
          ...
          <div className="grid grid-cols-2 gap-6 pt-6 border-t">
            <div>
              <label className="block text-sm font-medium text-[#9E8F75] mb-2">Category</label>
              <select
                value={category}
            ...
            <div className="space-y-2">
              <label className="flex items-center gap-2 text-sm text-[#9E8F75]">
                <input
                  type="checkbox"
        ...
        <div className="grid grid-cols-4 gap-6">
          ...
          {!previewMode && (
            <div className="bg-[#110F0B] rounded shadow-lg p-6">
              <h3 className="text-xl font-bold text-[#9E8F75] mb-4">Add Fields</h3>
              <div className="space-y-2">
          ...
          {/* Form Canvas */}
          <div className={`${previewMode ? 'col-span-4' : 'col-span-2'} bg-[#110F0B] rounded shadow-lg p-8`}>
            <h3 className="text-2xl font-bold text-[#9E8F75] mb-6">
            ...
            {previewMode && fields.length > 0 && (
              <div className="mt-8">
                <button className="w-full px-8 py-4 bg-[rgba(201,168,76,0.15)] hover:bg-[rgba(201,168,76,0.22)] border border-[rgba(201,168,76,0.45)] text-white text-lg rounded-lg">
                  Submit Form
                </button>
              </div>
            )}
          ...
          {!previewMode && selectedFieldData && (
            <div className="bg-[#110F0B] rounded shadow-lg p-6">
              <h3 className="text-xl font-bold text-[#9E8F75] mb-4">Field Properties</h3>
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-[#9E8F75] mb-2">Label</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-medium text-[#9E8F75] mb-2">Placeholder</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-medium text-[#9E8F75] mb-2">Help Text</label>
                  <textarea
                ...
                {['select', 'multiselect', 'checkbox', 'radio'].includes(selectedFieldData.type) && (
                  <div>
                    <label className="block text-sm font-medium text-[#9E8F75] mb-2">Options (one per line)</label>
                    <textarea
                ...
                <label className="flex items-center gap-2 text-sm">
                  <input
                    ...
                    className="rounded"
                  />
                  <span className="font-medium text-[#9E8F75]">Required field</span>
                </label>
              </div>
            </div>
          )}
...
function renderFieldInput(field: FormField) {
  switch (field.type) {
    ...
    case 'signature':
      return (
        <div className="w-full h-32 border-2 border-dashed rounded-lg flex items-center justify-center text-[#9E8F75]">
          Click to sign
        </div>
      );
    default:
