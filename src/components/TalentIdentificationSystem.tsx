    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        {topTalent.map((employee) => (
          <div
            key={employee.id}
            className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-xl rounded-xl p-6 border-2 border-cyan-500/30 hover:border-cyan-400/50 transition-all cursor-pointer"
          ...
          >
            ...
            <div className="flex items-center gap-4 mb-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-slate-400">{employee.tenure}</p>
              </div>
            ...
            {/* View Details */}
            <button className="w-full mt-3 px-4 py-2 bg-slate-700 hover:bg-slate-600 text-white rounded-lg font-semibold transition-all flex items-center justify-center gap-2">
              View Full Profile
      ...
      {selectedEmployee && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl p-8 max-w-4xl w-full border-2 border-cyan-500/30 shadow-2xl max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-4">
                <div className="w-20 h-20 bg-gradient-to-br from-cyan-500 to-blue-600 rounded-full flex items-center justify-center text-white font-bold text-2xl">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">{selectedEmployee.tenure}</p>
                </div>
              </div>
              <button
              ...
              <div className="md:col-span-2 bg-gradient-to-br from-green-500/10 to-emerald-500/10 rounded-lg p-6 border-2 border-green-500/30">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-slate-300">Employees Mentored</p>
                  </div>
                  <div className="text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-3 mt-6">
              ...
              <button className="px-4 py-3 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 rounded-lg font-bold text-white transition-all flex items-center justify-center gap-2">
                <TrendingUp className="w-5 h-5" />
                Consider Promotion
              </button>
              <button className="px-4 py-3 bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 rounded-lg font-bold text-white transition-all flex items-center justify-center gap-2">
                <Users className="w-5 h-5" />
                Assign Mentee
              </button>
              <button className="px-4 py-3 bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 rounded-lg font-bold text-white transition-all flex items-center justify-center gap-2">
