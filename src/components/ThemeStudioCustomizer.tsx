      ...
      <div className="lux-card rounded p-6 max-w-7xl w-full border-2 border-amber-500/40/30 shadow-2xl max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-[#9E8F75]">Customize every aspect of your experience</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="flex gap-2 flex-wrap">
              <button
                ...
                className={`px-4 py-2 rounded-lg font-semibold transition-all flex items-center gap-2 ${
                  activeTab === 'colors' ? 'bg-amber-500 text-white' : 'bg-[rgba(201,168,76,0.04)] text-[#9E8F75] hover:bg-[rgba(201,168,76,0.08)]'
                }`}
              >
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg font-semibold transition-all flex items-center gap-2 ${
                  activeTab === 'typography' ? 'bg-amber-500 text-white' : 'bg-[rgba(201,168,76,0.04)] text-[#9E8F75] hover:bg-[rgba(201,168,76,0.08)]'
                }`}
              >
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg font-semibold transition-all flex items-center gap-2 ${
                  activeTab === 'layout' ? 'bg-amber-500 text-white' : 'bg-[rgba(201,168,76,0.04)] text-[#9E8F75] hover:bg-[rgba(201,168,76,0.08)]'
                }`}
              >
              ...
              <button
                ...
                className={`px-4 py-2 rounded-lg font-semibold transition-all flex items-center gap-2 ${
                  activeTab === 'effects' ? 'bg-amber-500 text-white' : 'bg-[rgba(201,168,76,0.04)] text-[#9E8F75] hover:bg-[rgba(201,168,76,0.08)]'
                }`}
              >
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {[
                      ...
                      <div key={color.key} className="flex items-center justify-between p-3 bg-[rgba(201,168,76,0.04)] rounded-lg">
            ...
            {activeTab === 'typography' && (
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-4 bg-[rgba(201,168,76,0.04)] rounded-lg">
                    <label className="text-white font-semibold mb-3 block">Body Font</label>
                    <select
                      value={theme.fontFamily}
                      onChange={(e) => setTheme({ ...theme, fontFamily: e.target.value })}
                      className="w-full bg-[rgba(201,168,76,0.04)] text-white rounded-lg px-3 py-2"
                    >
            ...
            {activeTab === 'effects' && (
              <div className="space-y-4">
                {[
                  ...
                  <div key={effect.key} className="flex items-center justify-between p-4 bg-[rgba(201,168,76,0.04)] rounded-lg">
                    <div>
                      <p className="text-white font-semibold">{effect.label}</p>
                      <p className="text-sm text-[#9E8F75]">{effect.desc}</p>
                    </div>
                    <button
                    ...
                    >
                      <div className={`w-6 h-6 bg-[#110F0B] rounded-full transition-all ${
        ...
        <div className="flex gap-3 mt-6">
          ...
          <button
            ...
            className="px-6 py-3 bg-[rgba(201,168,76,0.04)] hover:bg-[rgba(201,168,76,0.08)] rounded-lg font-semibold text-white transition-all flex items-center gap-2"
          >
