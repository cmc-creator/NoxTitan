...
export default function QAPIPage() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'ACTION_PLAN': case 'IMPLEMENTING': case 'MONITORING': return 'bg-amber-900/30 text-amber-300';
  ...
  const getTrendIcon = (trend: string) => {
    ...
    return <ArrowRight className="w-4 h-4 text-stone-500" />;
  };
  ...
  return (
    <div className="p-8">
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-stone-500">Comprehensive quality management, risk assessment, and performance improvement tracking</p>
          </div>
      ...
      {/* Navigation Tabs */}
      <div className="mb-6 flex gap-2 overflow-x-auto border-b border-stone-800">
        <button
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-stone-950 p-6 rounded shadow-md border border-stone-800">
              ...
              <h3 className="text-sm font-medium text-stone-500 mb-1">Open Incidents</h3>
              <p className="text-3xl font-bold text-stone-100">{openIncidents}</p>
            ...
            <div className="bg-stone-950 p-6 rounded shadow-md border border-stone-800">
              ...
              <h3 className="text-sm font-medium text-stone-500 mb-1">Metrics On Target</h3>
              <p className="text-3xl font-bold text-stone-100">{metricsOnTarget}/{qualityMetrics.length}</p>
              <p className="text-xs text-stone-500 mt-1">
            ...
            <div className="bg-stone-950 p-6 rounded shadow-md border border-stone-800">
              ...
              <h3 className="text-sm font-medium text-stone-500 mb-1">Active PIP Projects</h3>
              <p className="text-3xl font-bold text-stone-100">{activePIPs}</p>
              <p className="text-xs text-stone-500 mt-1">
            ...
            <div className="bg-stone-950 p-6 rounded shadow-md border border-stone-800">
              ...
              <h3 className="text-sm font-medium text-stone-500 mb-1">High-Risk Items</h3>
              <p className="text-3xl font-bold text-stone-100">{highRisks}</p>
              <p className="text-xs text-stone-500 mt-1">
          ...
          <div className="bg-stone-950 p-6 rounded shadow-md border border-stone-800">
            ...
            <div className="space-y-4">
              {qualityMetrics.slice(0, 4).map((metric) => {
                ...
                return (
                  <div key={metric.id} className="border-b border-stone-800 pb-4 last:border-0">
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center gap-3">
                        <span className="font-medium text-stone-100">{metric.name}</span>
                      ...
                      <div className="text-right">
                        ...
                        <span className="text-sm text-stone-500 ml-2">/ {metric.target} target</span>
                      </div>
                    </div>
            ...
            <div className="bg-stone-950 p-6 rounded shadow-md border border-stone-800">
              ...
              <div className="space-y-3">
                {incidents.slice(0, 3).map((incident) => (
                  <div key={incident.id} className="p-4 bg-stone-950 rounded-lg hover:bg-stone-900 transition-all cursor-pointer">
                    <div className="flex items-start justify-between mb-2">
                      <div>
                        <span className={`px-2 py-1 rounded-full text-xs font-medium ${getSeverityColor(incident.severity)}`}>
                          {incident.severity}
                        </span>
                        <span className="text-xs text-stone-500 ml-2">{incident.id}</span>
                      </div>
                      <span className={`px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(incident.status)}`}>
                        {incident.status.replace('_', ' ')}
                      </span>
                    </div>
                    <h3 className="font-semibold text-stone-100 mb-1">{incident.type.replace('_', ' ')}</h3>
                    <p className="text-sm text-stone-500 mb-2">{incident.description}</p>
            ...
            <div className="bg-stone-950 p-6 rounded shadow-md border border-stone-800">
              ...
              <div className="space-y-3">
                {pipProjects.filter(p => p.status === 'IMPLEMENTING').map((project) => {
                  ...
                  return (
                    <div key={project.id} className="p-4 bg-stone-950 rounded-lg hover:bg-stone-900 transition-all cursor-pointer">
                      <div className="flex items-start justify-between mb-2">
                        ...
                        <span className="text-xs text-stone-500">{project.id}</span>
                      </div>
                      <h3 className="font-semibold text-stone-100 mb-2">{project.title}</h3>
                      <div className="mb-2">
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-stone-800">
                    <th className="text-left py-3 px-4 text-sm font-semibold text-stone-300">Risk Area</th>
                    <th className="text-center py-3 px-4 text-sm font-semibold text-stone-300">Likelihood</th>
                    <th className="text-center py-3 px-4 text-sm font-semibold text-stone-300">Impact</th>
                    <th className="text-center py-3 px-4 text-sm font-semibold text-stone-300">Risk Score</th>
                    <th className="text-left py-3 px-4 text-sm font-semibold text-stone-300">Status</th>
                    <th className="text-left py-3 px-4 text-sm font-semibold text-stone-300">Owner</th>
                  </tr>
                </thead>
                <tbody>
                  {riskAssessments.sort((a, b) => b.riskScore - a.riskScore).map((risk) => (
                    <tr key={risk.id} className="border-b border-stone-800 hover:bg-stone-950">
                      <td className="py-4 px-4">
                        <div className="font-medium text-stone-100">{risk.riskArea}</div>
                        <div className="text-xs text-stone-500">{risk.id}</div>
                      </td>
                      ...
                      <td className="py-4 px-4 text-sm text-stone-300">{risk.owner}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          <div className="bg-stone-950 p-4 rounded shadow-md border border-stone-800">
            <div className="flex gap-4">
              ...
              <select
                ...
                className="px-4 py-2 border border-stone-700 rounded-lg focus:ring-2 focus:ring-amber-500"
              >
              ...
              <div key={incident.id} className="bg-stone-950 p-6 rounded shadow-md border border-stone-800 hover:shadow-lg transition-all">
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm text-stone-500">{incident.id}</span>
                  </div>
                  <div className="flex gap-2">
                    <button className="p-2 hover:bg-stone-900 rounded-lg transition-all">
                ...
                <h3 className="text-lg font-bold text-stone-100 mb-2">{incident.type.replace('_', ' ')}</h3>
                <p className="text-stone-300 mb-4">{incident.description}</p>

                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                  <div>
                    <span className="text-xs text-stone-500">Department</span>
                    <p className="text-sm font-medium text-stone-100">{incident.department}</p>
                  </div>
                  <div>
                    <span className="text-xs text-stone-500">Date</span>
                    <p className="text-sm font-medium text-stone-100">{new Date(incident.date).toLocaleDateString()}</p>
                  </div>
                  <div>
                    <span className="text-xs text-stone-500">Reported By</span>
                    <p className="text-sm font-medium text-stone-100">{incident.reportedBy}</p>
                  </div>
                  <div>
                    <span className="text-xs text-stone-500">Assigned To</span>
                    <p className="text-sm font-medium text-stone-100">{incident.assignedTo || 'Unassigned'}</p>
                  </div>
                </div>
                ...
                {incident.correctiveAction && (
                  <div className="bg-amber-900/20 border-l-4 border-blue-400 p-3 rounded mb-3">
                    ...
                    <p className="text-sm text-amber-300">{incident.correctiveAction}</p>
                  </div>
                )}
                ...
                {incident.dueDate && (
                  <div className="flex items-center gap-2 text-sm">
                    ...
                    <span className="text-stone-500">Due: {new Date(incident.dueDate).toLocaleDateString()}</span>
            ...
            {qualityMetrics.map((metric) => {
              ...
              return (
                <div key={metric.id} className="bg-stone-950 p-6 rounded shadow-md border border-stone-800">
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                        ...
                        metric.category === 'CLINICAL' ? 'bg-amber-900/30 text-amber-300' :
                  ...
                  <h3 className="text-lg font-bold text-stone-100 mb-2">{metric.name}</h3>
                  ...
                  <div className="mb-4">
                    ...
                    <div className="text-sm text-stone-500">Target: {metric.target} {metric.unit}</div>
                  </div>
                  ...
                  <div className="flex items-center justify-between text-sm">
                    <div>
                      ...
                      <span className="font-medium text-stone-100">{metric.benchmark} {metric.unit}</span>
                    </div>
                    <div>
          ...
          {pipProjects.map((project) => {
            ...
            return (
              <div key={project.id} className="bg-stone-950 p-6 rounded shadow-md border border-stone-800">
                ...
                <h3 className="text-xl font-bold text-stone-100 mb-2">{project.title}</h3>
                <p className="text-stone-300 mb-4">{project.goal}</p>

                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                  <div className="bg-stone-950 p-3 rounded-lg">
                    <span className="text-xs text-stone-500">Baseline</span>
                    <p className="text-lg font-bold text-stone-100">{project.baseline}</p>
                  </div>
                ...
                <div className="mb-4">
                  <h4 className="font-semibold text-stone-100 mb-3">Milestones ({completedMilestones}/{totalMilestones})</h4>
                  <div className="space-y-2">
                    {project.milestones.map((milestone, index) => (
                      <div key={index} className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          <p className={`text-sm ${milestone.completed ? 'text-stone-500 line-through' : 'text-stone-100 font-medium'}`}>
                            {milestone.title}
                          </p>
                          <p className="text-xs text-stone-500">Due: {new Date(milestone.dueDate).toLocaleDateString()}</p>
                        </div>
                      </div>
                    ))}
                  </div>
                ...
                <div className="flex items-center justify-between pt-4 border-t border-stone-800">
                  <div className="text-sm">
                    ...
                    <span className="font-medium text-stone-100">{project.owner}</span>
                  </div>
                  <div className="text-sm">
                    <span className="text-stone-500">Target Date: </span>
                    <span className="font-medium text-stone-100">{new Date(project.targetDate).toLocaleDateString()}</span>
                  </div>
                </div>
              </div>
            );
            ...
            <div key={risk.id} className="bg-stone-950 p-6 rounded shadow-md border border-stone-800">
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-stone-100">{risk.riskArea}</h3>
                    <span className="text-sm text-stone-500">{risk.id}</span>
                  </div>
                </div>
              ...
              <p className="text-stone-300 mb-4">{risk.description}</p>

              <div className="grid grid-cols-2 gap-4 mb-4">
                <div className="bg-stone-950 p-4 rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm font-medium text-stone-300">Likelihood</span>
                ...
                <div className="bg-stone-950 p-4 rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-sm font-medium text-stone-300">Impact</span>
                    <span className={`px-2 py-1 rounded text-sm font-bold ${
                      risk.impact >= 4 ? 'bg-red-100 text-red-700' :
                      risk.impact >= 3 ? 'bg-yellow-100 text-yellow-700' :
                      'bg-green-100 text-green-700'
              ...
              <div className="bg-amber-900/20 border-l-4 border-blue-400 p-4 rounded mb-4">
                ...
                <p className="text-sm text-amber-300">{risk.mitigationPlan}</p>
              </div>

              <div className="flex items-center justify-between pt-4 border-t border-stone-800 text-sm">
                <div>
                  <span className="text-stone-500">Owner: </span>
                  <span className="font-medium text-stone-100">{risk.owner}</span>
                </div>
                <div>
                  <span className="text-stone-500">Next Review: </span>
                  <span className="font-medium text-stone-100">{new Date(risk.reviewDate).toLocaleDateString()}</span>
                </div>
              </div>
            </div>
          ))}
          ...
          <div className="bg-stone-950 p-6 rounded shadow-md border border-stone-800">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-green-50 p-6 rounded-lg border border-green-200">
                ...
                <h3 className="font-bold text-stone-100 mb-2">Compliance Score</h3>
                <p className="text-4xl font-bold text-green-600 mb-2">94%</p>
                <p className="text-sm text-stone-500">18 out of 19 standards met</p>
              </div>

              <div className="bg-amber-900/20 p-6 rounded-lg border border-blue-200">
                <Calendar className="w-8 h-8 text-amber-400 mb-3" />
                <h3 className="font-bold text-stone-100 mb-2">Upcoming Audits</h3>
                <p className="text-4xl font-bold text-amber-400 mb-2">3</p>
                <p className="text-sm text-stone-500">Next audit in 12 days</p>
              </div>

              <div className="bg-yellow-50 p-6 rounded-lg border border-yellow-200">
                <AlertCircle className="w-8 h-8 text-yellow-600 mb-3" />
                <h3 className="font-bold text-stone-100 mb-2">Open Findings</h3>
                <p className="text-4xl font-bold text-yellow-600 mb-2">2</p>
                <p className="text-sm text-stone-500">Require corrective action</p>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-r from-amber-700 to-amber-900 p-6 rounded border-2 border-blue-200">
            <div className="flex items-start gap-4 mb-4">
              ...
              <div className="flex-1">
                <h2 className="text-xl font-bold text-stone-100 mb-2">Data Integration Hub</h2>
                <p className="text-stone-300 mb-4">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  <div className="bg-stone-950 p-3 rounded-lg border border-green-200">
                    <CheckCircle className="w-5 h-5 text-green-600 mb-1" />
                    <p className="text-xs font-semibold text-stone-100">HR Analytics</p>
                    <p className="text-xs text-stone-500">Connected</p>
                  </div>
                  <div className="bg-stone-950 p-3 rounded-lg border border-green-200">
                    <CheckCircle className="w-5 h-5 text-green-600 mb-1" />
                    <p className="text-xs font-semibold text-stone-100">Time & Attendance</p>
                    <p className="text-xs text-stone-500">Connected</p>
                  </div>
                  <div className="bg-stone-950 p-3 rounded-lg border border-green-200">
                    <CheckCircle className="w-5 h-5 text-green-600 mb-1" />
                    <p className="text-xs font-semibold text-stone-100">Incidents</p>
                    <p className="text-xs text-stone-500">Connected</p>
                  </div>
                  <div className="bg-stone-950 p-3 rounded-lg border border-green-200">
                    <CheckCircle className="w-5 h-5 text-green-600 mb-1" />
                    <p className="text-xs font-semibold text-stone-100">Compliance</p>
                    <p className="text-xs text-stone-500">Connected</p>
                  </div>
                  <div className="bg-stone-950 p-3 rounded-lg border border-green-200">
                    <CheckCircle className="w-5 h-5 text-green-600 mb-1" />
                    <p className="text-xs font-semibold text-stone-100">Scheduling</p>
                    <p className="text-xs text-stone-500">Connected</p>
                  </div>
                  <div className="bg-stone-950 p-3 rounded-lg border border-green-200">
                    <CheckCircle className="w-5 h-5 text-green-600 mb-1" />
                    <p className="text-xs font-semibold text-stone-100">Patient Satisfaction</p>
                    <p className="text-xs text-stone-500">Connected</p>
                  </div>
                  <div className="bg-stone-950 p-3 rounded-lg border border-green-200">
                    <CheckCircle className="w-5 h-5 text-green-600 mb-1" />
                    <p className="text-xs font-semibold text-stone-100">Financial Data</p>
                    <p className="text-xs text-stone-500">Connected</p>
                  </div>
                  <div className="bg-stone-950 p-3 rounded-lg border border-green-200">
                    <CheckCircle className="w-5 h-5 text-green-600 mb-1" />
                    <p className="text-xs font-semibold text-stone-100">Clinical Metrics</p>
                    <p className="text-xs text-stone-500">Connected</p>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-2 border border-stone-700 rounded-lg focus:ring-2 focus:ring-amber-500"
                >
          ...
          {selectedReportType === 'executive' && (
            <div className="bg-stone-950 p-8 rounded shadow-md border border-stone-800">
              ...
              {/* Charts Section */}
              <div className="mb-8">
                <h2 className="text-xl font-bold text-stone-100 mb-4 border-b-2 border-stone-800 pb-2">Visual Analytics</h2>
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  {/* Incident Trend Chart */}
                  <div className="bg-stone-950 p-6 rounded-lg border border-stone-800">
                    <h3 className="font-bold text-stone-100 mb-4 flex items-center gap-2">
                      <BarChart3 className="w-5 h-5 text-amber-400" />
                        ...
                        return (
                          <div key={month}>
                            <div className="flex items-center justify-between mb-1">
                              <span className="text-sm font-medium text-stone-300">{month}</span>
                              <span className="text-sm font-bold text-stone-100">{value} incidents</span>
                            </div>
                  ...
                  <div className="bg-stone-950 p-6 rounded-lg border border-stone-800">
                    ...
                    <div className="space-y-4">
                      {[
                        ...
                        <div key={metric.name}>
                          <div className="flex items-center justify-between mb-1">
                            <span className="text-sm font-medium text-stone-300">{metric.name}</span>
                            <div className="flex items-center gap-2">
                              <span className="text-xs text-stone-500">{metric.current} / {metric.target}</span>
              ...
              <div className="mb-8">
                <h2 className="text-xl font-bold text-stone-100 mb-4 border-b-2 border-stone-800 pb-2">Department Performance Scorecard</h2>
                <div className="overflow-x-auto">
                  <table className="w-full">
                    <thead className="bg-stone-900">
                      <tr>
                        <th className="text-left py-3 px-4 text-sm font-semibold text-stone-300">Department</th>
                        <th className="text-center py-3 px-4 text-sm font-semibold text-stone-300">Safety Score</th>
                        <th className="text-center py-3 px-4 text-sm font-semibold text-stone-300">Quality Score</th>
                        <th className="text-center py-3 px-4 text-sm font-semibold text-stone-300">Incidents</th>
                        <th className="text-center py-3 px-4 text-sm font-semibold text-stone-300">Compliance</th>
                        <th className="text-center py-3 px-4 text-sm font-semibold text-stone-300">Overall</th>
                      </tr>
                    </thead>
                    <tbody>
                      {[
                        ...
                        <tr key={index} className="border-b border-stone-800 hover:bg-stone-950">
                          <td className="py-3 px-4 font-medium text-stone-100">{dept.dept}</td>
                          ...
                          <td className="text-center py-3 px-4 text-stone-300">{dept.incidents}</td>
                          <td className="text-center py-3 px-4">
                            <span className={`px-2 py-1 rounded text-sm font-medium ${
              ...
              {/* Action Items */}
              <div className="mb-8">
                <h2 className="text-xl font-bold text-stone-100 mb-4 border-b-2 border-stone-800 pb-2">Action Items & Recommendations</h2>
                <div className="space-y-3">
                  ...
                  <div className="flex items-start gap-3 p-4 bg-amber-900/20 rounded-lg border border-blue-200">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-amber-300">Barcode scanning implementation on track. Next milestone: Smart pump integration by Q2 2026.</p>
                    </div>
                  </div>
              ...
              <div className="pt-6 border-t border-stone-800">
                <div className="flex items-center justify-between text-sm text-stone-500">
                  ...
                  <div className="text-right">
                    <p className="font-semibold text-stone-100">Prepared by: Quality & Safety Department</p>
          ...
          <div className="bg-stone-950 p-6 rounded shadow-md border border-stone-800">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                ...
                <div key={index} className="p-4 border-2 border-stone-800 rounded-lg hover:border-blue-400 hover:shadow-md transition-all cursor-pointer">
                  ...
                  <h3 className="font-bold text-stone-100 mb-1">{template.name}</h3>
                  <p className="text-sm text-stone-500">{template.desc}</p>
                  <button className="mt-3 text-sm text-amber-400 hover:text-amber-300 font-medium">
                    Generate Report →
                  </button>
                </div>
              ))}
          ...
          <div className="bg-gradient-to-r from-stone-900 to-pink-50 p-6 rounded border-2 border-purple-200">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h2 className="text-xl font-bold text-stone-100 mb-2">Custom Chart Builder</h2>
                <p className="text-stone-300 mb-4">
        ...
        <div className="space-y-6">
            ...
            <div className="flex gap-3">
              <button
                ...
                className={`px-6 py-3 rounded-lg font-medium transition-all flex items-center gap-2 ${
                  importType === 'file' ? 'bg-amber-600 text-white shadow-lg' : 'bg-stone-950 text-stone-300 hover:bg-stone-900'
                }`}
              >
              ...
              <button
                ...
                className={`px-6 py-3 rounded-lg font-medium transition-all flex items-center gap-2 ${
                  importType === 'integration' ? 'bg-amber-600 text-white shadow-lg' : 'bg-stone-950 text-stone-300 hover:bg-stone-900'
                }`}
              >
              ...
              <button
                ...
                className={`px-6 py-3 rounded-lg font-medium transition-all flex items-center gap-2 ${
                  importType === 'manual' ? 'bg-amber-600 text-white shadow-lg' : 'bg-stone-950 text-stone-300 hover:bg-stone-900'
                }`}
              >
            ...
            <div className="space-y-6">
              ...
              <div className="bg-stone-950 p-6 rounded shadow-md border border-stone-800">
                    ...
                    <button
                      ...
                      className={`p-4 border-2 rounded-lg transition-all text-left ${
                        selectedFileType === format.type
                          ...
                          : 'border-stone-800 hover:border-blue-300'
                      }`}
                    >
                      <format.icon className={`w-8 h-8 mb-2 ${
                        selectedFileType === format.type ? 'text-amber-400' : 'text-stone-400'
                      }`} />
                      <p className="font-semibold text-stone-100">{format.name}</p>
                      <p className="text-xs text-stone-500">{format.desc}</p>
                    </button>
                  ))}
                </div>
                ...
                <div className="border-2 border-dashed border-stone-700 rounded p-8 text-center hover:border-blue-400 transition-all cursor-pointer bg-stone-950">
                  ...
                  <p className="text-xs text-stone-500 mt-3">Max file size: 10MB</p>
                </div>
              </div>
              ...
              <div className="bg-stone-950 p-6 rounded shadow-md border border-stone-800">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {[
                    ...
                    <div
                      key={dataType.type}
                      className="p-4 border-2 border-stone-800 rounded-lg hover:border-blue-400 hover:shadow-md transition-all cursor-pointer"
                    >
                      ...
                      <h4 className="font-bold text-stone-100 mb-1">{dataType.name}</h4>
                      <p className="text-sm text-stone-500">{dataType.desc}</p>
                    </div>
                  ))}
                </div>
              </div>
                ...
                <div className="bg-stone-950 p-4 rounded-lg border border-stone-800">
                  <div className="space-y-2">
                    <div className="flex items-center justify-between p-3 bg-stone-950 rounded border border-stone-800">
                      <span className="font-medium text-stone-300">Your Field: "Satisfaction Score"</span>
                      <ArrowRight className="w-5 h-5 text-stone-400" />
                      <span className="font-medium text-amber-400">QAPI Field: "Current Value"</span>
                    </div>
                    <div className="flex items-center justify-between p-3 bg-stone-950 rounded border border-stone-800">
                      <span className="font-medium text-stone-300">Your Field: "Date Collected"</span>
                      <ArrowRight className="w-5 h-5 text-stone-400" />
                      <span className="font-medium text-amber-400">QAPI Field: "Last Updated"</span>
                    </div>
                    <div className="flex items-center justify-between p-3 bg-stone-950 rounded border border-stone-800">
                      <span className="font-medium text-stone-300">Your Field: "Department"</span>
                      <ArrowRight className="w-5 h-5 text-stone-400" />
              ...
              <div className="bg-amber-900/20 p-6 rounded border-2 border-blue-200">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-stone-100 mb-2">Download Import Templates</h3>
                    <p className="text-stone-300 mb-4">
            ...
            <div className="space-y-6">
              <div className="bg-stone-950 p-6 rounded shadow-md border border-stone-800">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {[
                    ...
                    <div key={index} className="p-4 border-2 border-stone-800 rounded-lg hover:border-blue-400 hover:shadow-md transition-all">
                      <div className="flex items-start justify-between mb-3">
                        ...
                        <span className={`px-3 py-1 text-xs font-semibold rounded-full ${
                          integration.status === 'Available' ? 'bg-green-100 text-green-700' : 'bg-stone-900 text-stone-500'
                        }`}>
                          {integration.status}
                        </span>
                      </div>
                      <h4 className="font-bold text-stone-100 mb-1">{integration.name}</h4>
                      <p className="text-sm text-stone-500 mb-3">{integration.desc}</p>
                      <button 
              ...
              <div className="bg-gradient-to-r from-amber-700 to-amber-500 p-6 rounded border-2 border-indigo-200">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold text-stone-100 mb-2">Custom API Integration</h3>
                    <p className="text-stone-300 mb-4">
                    ...
                    <div className="flex gap-3">
                      ...
                      <button className="px-4 py-2 bg-stone-950 hover:bg-stone-900 text-stone-300 border border-stone-700 rounded-lg font-medium transition-all flex items-center gap-2">
          ...
          {importType === 'manual' && (
            <div className="bg-stone-950 p-6 rounded shadow-md border border-stone-800">
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-stone-300 mb-2">Data Type</label>
                  <select className="w-full px-4 py-2 border border-stone-700 rounded-lg focus:ring-2 focus:ring-amber-500">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-stone-300 mb-2">Source</label>
                    <input 
                      type="text" 
                  ...
                  <div>
                    <label className="block text-sm font-medium text-stone-300 mb-2">Date Collected</label>
                    <input 
                      type="date" 
                      className="w-full px-4 py-2 border border-stone-700 rounded-lg focus:ring-2 focus:ring-amber-500"
                    />
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-stone-300 mb-2">Value/Score</label>
                    <input 
                      type="number" 
                      placeholder="85"
                      className="w-full px-4 py-2 border border-stone-700 rounded-lg focus:ring-2 focus:ring-amber-500"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-stone-300 mb-2">Target</label>
                    <input 
                      type="number" 
                      placeholder="90"
                      className="w-full px-4 py-2 border border-stone-700 rounded-lg focus:ring-2 focus:ring-amber-500"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-stone-300 mb-2">Unit</label>
                    <input 
                      type="text" 
                      placeholder="%"
                      className="w-full px-4 py-2 border border-stone-700 rounded-lg focus:ring-2 focus:ring-amber-500"
                ...
                <div className="flex gap-3">
                  ...
                  <button className="px-6 py-3 bg-stone-950 hover:bg-stone-900 text-stone-300 border border-stone-700 rounded-lg font-medium transition-all">
                    Reset Form
                  </button>
                </div>
              </div>
              ...
              <table className="w-full">
                <thead className="bg-stone-900">
                  <tr>
                    ...
                    <th className="text-left py-3 px-4 text-sm font-semibold text-stone-300">Source</th>
                    <th className="text-left py-3 px-4 text-sm font-semibold text-stone-300">Data Type</th>
                    <th className="text-center py-3 px-4 text-sm font-semibold text-stone-300">Records</th>
                    <th className="text-center py-3 px-4 text-sm font-semibold text-stone-300">Status</th>
                    <th className="text-left py-3 px-4 text-sm font-semibold text-stone-300">Imported By</th>
                  </tr>
                </thead>
                <tbody>
                  {[
                    ...
                    <tr key={index} className="border-b border-stone-800 hover:bg-stone-950">
                      <td className="py-3 px-4 text-sm text-stone-300">{import_.date}</td>
                      <td className="py-3 px-4 text-sm font-medium text-stone-100">{import_.source}</td>
                      <td className="py-3 px-4 text-sm text-stone-300">{import_.type}</td>
                      <td className="text-center py-3 px-4 text-sm font-semibold text-stone-100">{import_.records}</td>
                      <td className="text-center py-3 px-4">
                        <span className="px-3 py-1 bg-green-100 text-green-700 rounded-full text-xs font-semibold">
                          {import_.status}
                        </span>
                      </td>
                      <td className="py-3 px-4 text-sm text-stone-300">{import_.user}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
