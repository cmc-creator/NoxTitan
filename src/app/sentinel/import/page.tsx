...
export default function SentinelImportPage() {
 ...
 <p className="text-[#9E8F75] mb-8">Import from Tally, Google Forms, or CSV files</p>
 ...
 <p className="text-sm text-[#9E8F75]">Import from Tally.so</p>
 </button>
 ...
 <p className="text-sm text-[#9E8F75]">Import from Forms</p>
 </button>
 ...
 <p className="text-sm text-[#9E8F75]">Upload CSV file</p>
 </button>
 </div>
 </div>
 ...
 className="w-full px-4 py-3 bg-[rgba(201,168,76,0.04)] border border-[rgba(201,168,76,0.22)] rounded-lg text-white focus:outline-none focus:border-amber-500/40"
 />
 </div>
 <button
