...
export default function EmployeesPage() {
 ...
 className={`w-12 h-12 rounded-full border-2 ${selectedEmployee?.avatar === avatarUrl ? 'border-amber-500/40 ring-2 ring-[rgba(201,168,76,0.45)]' : 'border-[rgba(201,168,76,0.22)]'} hover:border-[rgba(201,168,76,0.22)] 400 transition-all`}
 >
 ...
 name="firstName"
 required
 className="w-full px-4 py-2.5 border border-[rgba(201,168,76,0.22)] rounded-lg text-[#9E8F75] focus:outline-none focus:border-amber-500/40 focus:ring-2 focus:ring-[rgba(201,168,76,0.45)]"
 placeholder="John"
 />
 </div>
 <div>
 ...
 className="w-full px-4 py-2.5 border border-[rgba(201,168,76,0.22)] rounded-lg focus:outline-none focus:border-[rgba(201,168,76,0.22)] 500 focus:ring-2 focus:ring-[rgba(201,168,76,0.45)] mb-3"
 required
 >
 ...
 <div className="bg-[rgba(201,168,76,0.04)] border border-[rgba(201,168,76,0.22)] rounded-lg p-3">
 <p className="text-xs text-[#5A5040]">
 <strong>Note:</strong> Deactivating an employee will:
 </p>
 <ul className="text-xs text-[#5A5040] mt-2 ml-4 list-disc space-y-1">
 ...
 <svg className="h-5 w-5 text-[#C9A84C]" viewBox="0 0 20 20" fill="currentColor">
