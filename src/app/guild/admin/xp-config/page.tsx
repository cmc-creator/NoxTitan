    ...
    <div className="min-h-screen bg-[#070604] via-stone-900 to-pink-900 p-8">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-[#9E8F75]">Configure XP point values for all activities, achievements, and actions</p>
        </div>
        ...
        <div className="bg-[rgba(201,168,76,0.06)]/50 border border-[rgba(201,168,76,0.22)] rounded p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              <label className="block text-sm font-semibold text-[#9E8F75] mb-2">Easy Activities</label>
              <input
                type="number"
                value={settings.activityEasy}
                onChange={(e) => updateSetting('activityEasy', parseInt(e.target.value))}
                className="w-full px-4 py-2 bg-[#110F0B]/50 border border-[rgba(201,168,76,0.22)] rounded-lg text-white"
              />
            </div>
            <div>
              <label className="block text-sm font-semibold text-[#9E8F75] mb-2">Medium Activities</label>
              <input
                type="number"
            ...
            <div>
              <label className="block text-sm font-semibold text-[#9E8F75] mb-2">Hard Activities</label>
              <input
                type="number"
        ...
        <div className="bg-[rgba(201,168,76,0.06)]/50 border border-[rgba(201,168,76,0.22)] rounded p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div>
              <label className="block text-sm font-semibold text-[#9E8F75] mb-2">Common</label>
              <input
                type="number"
            ...
            <div>
              <label className="block text-sm font-semibold text-amber-400 mb-2">Epic</label>
              <input
                type="number"
        ...
        <div className="bg-[rgba(201,168,76,0.06)]/50 border border-[rgba(201,168,76,0.22)] rounded p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <div>
              <label className="block text-sm font-semibold text-[#9E8F75] mb-2">Clock In</label>
              <input
                type="number"
            ...
            <div>
              <label className="block text-sm font-semibold text-[#9E8F75] mb-2">On-Time Clock In</label>
              <input
                type="number"
            ...
            <div>
              <label className="block text-sm font-semibold text-[#9E8F75] mb-2">Perfect Week</label>
              <input
                type="number"
            ...
            <div>
              <label className="block text-sm font-semibold text-[#9E8F75] mb-2">Training Completion</label>
              <input
                type="number"
            ...
            <div>
              <label className="block text-sm font-semibold text-[#9E8F75] mb-2">Shift Completion</label>
              <input
                type="number"
        ...
        <div className="bg-[rgba(201,168,76,0.06)]/50 border border-[rgba(201,168,76,0.22)] rounded p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-semibold text-[#9E8F75] mb-2">Receiving Recognition</label>
              <input
                type="number"
            ...
            <div>
              <label className="block text-sm font-semibold text-[#9E8F75] mb-2">Giving Recognition</label>
              <input
                type="number"
        ...
        <div className="bg-[rgba(201,168,76,0.06)]/50 border border-[rgba(201,168,76,0.22)] rounded p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-semibold text-[#9E8F75] mb-2">Level Up Bonus</label>
              <input
                type="number"
            ...
            <div>
              <label className="block text-sm font-semibold text-[#9E8F75] mb-2">Daily Streak Bonus</label>
              <input
                type="number"
        ...
        <div className="flex gap-4">
          <button
            onClick={handleSave}
            className="flex items-center gap-2 px-6 py-3 bg-[#110F0B] from-REMOVED-600 to-emerald-600 hover:from-[#110F0B] 700 text-white font-bold rounded-lg transition-all"
          >
