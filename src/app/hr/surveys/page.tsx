...
export default function EmployeeSurveysPage() {
 ...
 <p className="text-[#9E8F75]">Track 30/60/90 day satisfaction and engagement</p>
 </div>
 <button
 ...
 <p className="text-[#C9A84C] font-semibold">Avg. Score</p>
 </div>
 </div>
 ...
 <p className="text-[#9E8F75]">Loading surveys...</p>
 </div>
 ) : filteredSurveys.length === 0 ? (
 <div className="bg-[rgba(201,168,76,0.06)]/50 border border-[rgba(201,168,76,0.22)] rounded p-12 text-center">
 <ClipboardCheck className="w-16 h-16 text-[#9E8F75] mx-auto mb-4" />
 <h3 className="text-xl font-bold text-white mb-2">No Surveys Found</h3>
 <p className="text-[#9E8F75] mb-6">Schedule your first employee survey!</p>
 <button
 onClick={() => setShowCreateModal(true)}
 ...
 <div
 key={survey.id}
 className="bg-[rgba(201,168,76,0.06)]/50 border border-[rgba(201,168,76,0.22)] rounded p-6 hover:border-[rgba(201,168,76,0.45)]/50 transition-colors"
 >
 ...
 {survey.feedback && (
 <div className="bg-[rgba(201,168,76,0.06)]/30 rounded-lg p-3 text-sm text-[#9E8F75]">
