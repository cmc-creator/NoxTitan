...
export default function CompensationManagement() {
 ...
 <p className="text-[#9E8F75]">Salary planning, market benchmarking & total rewards</p>
 </div>
 </div>
 </div>
 ...
 <div className="text-[#9E8F75] text-sm mb-1">Total Budget</div>
 <div className="text-3xl font-bold text-white">${(totalBudget.allocated / 1000).toFixed(0)}K</div>
 <div className="text-[#9E8F75] text-xs mt-1">FY 2026 allocation</div>
 </div>
 <div className="bg-[rgba(201,168,76,0.06)] rounded p-6 border-2 border-amber-500/40/30">
 <div className="text-[#9E8F75] text-sm mb-1">Proposed</div>
 ...
 <div className="text-[#9E8F75] text-sm mb-1">Remaining</div>
 ...
 activeTab === 'planning' ? 'bg-[rgba(201,168,76,0.15)] text-white' : 'text-[#9E8F75] hover:bg-[#110F0B]'
 }`}
 >
 Merit Planning
 </button>
 ...
 className={`flex-1 px-4 py-2 rounded-lg font-semibold transition-all ${
 activeTab === 'bonuses' ? 'bg-[rgba(201,168,76,0.15)] text-white' : 'text-[#9E8F75] hover:bg-[#110F0B]'
 }`}
 >
 Bonuses & Incentives
 </button>
 ...
 className={`flex-1 px-4 py-2 rounded-lg font-semibold transition-all ${
 activeTab === 'market' ? 'bg-[rgba(201,168,76,0.15)] text-white' : 'text-[#9E8F75] hover:bg-[#110F0B]'
 }`}
 >
 Market Benchmarking
 </button>
 ...
 <button className="px-4 py-2 bg-[rgba(201,168,76,0.04)] hover:bg-[rgba(201,168,76,0.08)] text-white rounded-lg font-semibold">
 Export to Excel
 </button>
 <button className="px-4 py-2 bg-[rgba(201,168,76,0.15)] hover:bg-[rgba(201,168,76,0.15)] text-white rounded-lg font-semibold">
 Submit for Approval
 </button>
 </div>
 </div>
 ...
 <thead>
 <tr className="border-b-2 border-[rgba(201,168,76,0.22)]">
 <th className="text-left py-3 px-4 text-[#9E8F75] font-semibold">Employee</th>
 <th className="text-left py-3 px-4 text-[#9E8F75] font-semibold">Position</th>
 <th className="text-center py-3 px-4 text-[#9E8F75] font-semibold">Current</th>
 <th className="text-center py-3 px-4 text-[#9E8F75] font-semibold">Market</th>
 <th className="text-center py-3 px-4 text-[#9E8F75] font-semibold">Compa-Ratio</th>
 <th className="text-center py-3 px-4 text-[#9E8F75] font-semibold">Increase %</th>
 <th className="text-center py-3 px-4 text-[#9E8F75] font-semibold">New Salary</th>
 <th className="text-center py-3 px-4 text-[#9E8F75] font-semibold">Status</th>
 </tr>
 </thead>
 <tbody>
 {employees.map(emp => (
 <tr key={emp.id} className="border-b border-[rgba(201,168,76,0.22)] hover:bg-[rgba(201,168,76,0.06)]/30 transition-colors">
 <td className="py-4 px-4">
 <div className="text-white font-semibold">{emp.name}</div>
 <div className="text-xs text-[#9E8F75]">{emp.department}</div>
 </td>
 <td className="py-4 px-4 text-[#9E8F75]">{emp.position}</td>
 ...
 className="w-20 px-2 py-1 bg-[rgba(201,168,76,0.04)] border border-[rgba(201,168,76,0.22)] rounded text-white text-center focus:ring-2 focus:ring-[rgba(201,168,76,0.45)] outline-none"
 step="0.5"
 />
 </td>
 <td className="py-4 px-4 text-center text-[#9E8F75] font-bold text-lg">
 ...
 {bonuses.map(bonus => (
 <div key={bonus.id} className="bg-[rgba(201,168,76,0.04)] rounded-lg p-5 border border-amber-500/40/30">
 ...
 <div>
 <div className="text-xs text-[#9E8F75] mb-1">Target Bonus</div>
 <div className="text-white font-semibold">${bonus.targetBonus.toLocaleString()}</div>
 </div>
 <div>
 <div className="text-xs text-[#9E8F75] mb-1">Actual Bonus</div>
 <div className="text-[#9E8F75] font-bold text-xl">${bonus.actualBonus.toLocaleString()}</div>
 </div>
 <div>
 <div className="text-xs text-[#9E8F75] mb-1">Variance</div>
 <div className={`font-bold ${
 bonus.actualBonus > bonus.targetBonus ? 'text-[#9E8F75]' : 'text-white'
 }`}>
 ...
 <div className="grid grid-cols-4 gap-6">
 <div>
 <div className="text-[#9E8F75] text-sm mb-1">Total Pool</div>
 <div className="text-3xl font-bold text-white">$125K</div>
 </div>
 <div>
 <div className="text-[#9E8F75] text-sm mb-1">Allocated</div>
 <div className="text-3xl font-bold text-amber-400">$98K</div>
 </div>
 <div>
 <div className="text-[#9E8F75] text-sm mb-1">Remaining</div>
 <div className="text-3xl font-bold text-[#9E8F75]">$27K</div>
 </div>
 <div>
 <div className="text-[#9E8F75] text-sm mb-1">Utilization</div>
 ...
 <div key={idx} className="bg-[#110F0B]/50 rounded-lg p-5 border border-[rgba(201,168,76,0.22)]">
 <div className="flex items-center justify-between mb-4">
 <div>
 <h3 className="text-xl font-bold text-white">{role.position}</h3>
 <div className="text-sm text-[#9E8F75]">{role.count} employees in role</div>
 </div>
 <div className="text-right">
 <div className="text-sm text-[#9E8F75]">Our Average</div>
 ...
 <div className="text-xs text-[#9E8F75] mt-1">25th</div>
 ...
 <div className="text-center">
 <div className="w-1 h-8 bg-[rgba(201,168,76,0.15)]"></div>
 <div className="text-xs text-[#9E8F75] mt-1">75th</div>
 ...
 Gap to 50th: <span className="font-bold text-amber-400">
