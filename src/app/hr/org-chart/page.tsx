...
export default function OrgChart() {
 ...
 ? 'bg-[rgba(201,168,76,0.06)] border-amber-500/40'
 ...
 <div className="w-12 h-12 rounded-full bg-[rgba(201,168,76,0.08)] flex items-center justify-center text-white font-bold text-lg">
 {node.name.split(' ').map((n: string) => n[0]).join('')}
 </div>
 
 <div className="flex-1">
 <div className="text-white font-bold">{node.name}</div>
 <div className="text-sm text-[#9E8F75]">{node.title}</div>
 </div>
 
 <div className="text-right">
 <div className="text-sm text-[#9E8F75]">Direct Reports</div>
 ...
 <Users className="w-8 h-8 text-amber-400 mb-2" />
 <div className="text-[#9E8F75] text-sm mb-1">Departments</div>
 ...
 {/* Org Chart Tree */}
 <div className="col-span-2 bg-[rgba(201,168,76,0.06)]/50 rounded p-6 border-2 border-amber-500/40/30">
 ...
 <div className="w-24 h-24 rounded-full bg-[rgba(201,168,76,0.08)] flex items-center justify-center text-white font-bold text-3xl mb-3">
 {selectedEmployee.name.split(' ').map((n: string) => n[0]).join('')}
 </div>
 <h3 className="text-xl font-bold text-white text-center">{selectedEmployee.name}</h3>
 <div className="text-[#9E8F75] text-center">{selectedEmployee.title}</div>
 ...
 <div>
 <div className="text-xs text-[#9E8F75] mb-1">Email</div>
 <div className="text-white">{selectedEmployee.email}</div>
 </div>
 </div>

 <div className="flex items-start gap-3">
 <Phone className="w-5 h-5 text-[#9E8F75] mt-1" />
 <div>
 <div className="text-xs text-[#9E8F75] mb-1">Phone</div>
 ...
 <div>
 <div className="text-xs text-[#9E8F75] mb-1">Tenure</div>
 ...
 <button className="w-full px-4 py-2 bg-[rgba(201,168,76,0.04)] hover:bg-[rgba(201,168,76,0.08)] text-white rounded-lg">
 Send Message
 </button>
 <button className="w-full px-4 py-2 bg-[rgba(201,168,76,0.04)] hover:bg-[rgba(201,168,76,0.08)] text-white rounded-lg">
 View Team
 ...
 <Users className="w-16 h-16 text-[#9E8F75] mb-4" />
 <div className="text-[#9E8F75]">Select an employee to view details</div>
 </div>
 )}
 </div>
 </div>
