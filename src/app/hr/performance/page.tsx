      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-5 gap-4 mb-8">
          <div className="bg-[rgba(201,168,76,0.06)] rounded p-4 border-2 border-amber-500/40/30">
            <div className="text-[#9E8F75] text-sm mb-1">Total Reviews</div>
          ...
          <div className="bg-[rgba(201,168,76,0.06)] rounded p-4 border-2 border-[rgba(201,168,76,0.22)]">
            <div className="text-[#9E8F75] text-sm mb-1">Completed</div>
          ...
          <div className="bg-[rgba(201,168,76,0.04)] rounded p-4 border-2 border-amber-500/40/30">
            <div className="text-[#9E8F75] text-sm mb-1">Avg Rating</div>
                ...
                <div key={review.id} className="bg-[#110F0B]/50 rounded-lg p-5 border border-[rgba(201,168,76,0.22)] hover:border-orange-500 transition-all">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <div className="text-[#9E8F75] mb-3">{review.position}</div>
                      <div className="grid grid-cols-3 gap-4 mb-3">
                        <div>
                          <div className="text-xs text-[#9E8F75]">Reviewer</div>
                          <div className="text-white font-semibold">{review.reviewer}</div>
                        </div>
                        <div>
                          <div className="text-xs text-[#9E8F75]">Due Date</div>
                        ...
                        <div>
                          <div className="text-xs text-[#9E8F75]">Progress</div>
                  ...
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <span className={`px-3 py-1 rounded-full text-xs font-bold ${
                          goal.status === 'exceeding' ? 'bg-[rgba(201,168,76,0.15)] text-white' :
                    ...
                    <div className="text-right ml-4">
                      ...
                      <div className="text-xs text-[#9E8F75]">Complete</div>
                    </div>
                  </div>
          ...
          <div className="bg-[rgba(201,168,76,0.06)]/50 rounded p-6 border-2 border-amber-500/40/30">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex items-center gap-4">
                <div className="text-right">
                  <div className="text-sm text-[#9E8F75]">Overall Rating</div>
            ...
            <div className="space-y-4">
              {feedback360.map((feedback, idx) => (
                <div key={idx} className="bg-[rgba(201,168,76,0.04)] rounded-lg p-5 border border-amber-500/40/30">
                  <div className="flex items-start justify-between mb-3">
                    <div>
                      <h3 className="text-white font-bold mb-1">{feedback.from}</h3>
                      <div className="text-sm text-[#9E8F75]">{feedback.date}</div>
                    </div>
                    <div className="flex items-center gap-1">
                      {[1,2,3,4,5].map(star => (
            ...
            <div className="mt-6 bg-[#110F0B] 900/30 rounded-lg p-4 border border-amber-500/40/30">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-[#9E8F75]">Send continuous feedback to colleagues anytime</div>
                </div>
