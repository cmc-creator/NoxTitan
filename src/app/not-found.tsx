...
export default function NotFound() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-[rgba(201,168,76,0.08)]">
      <div className="text-center px-4">
        <h1 className="text-6xl font-bold text-white mb-4">404</h1>
        <h2 className="text-2xl font-semibold text-gray-200 mb-6">Page Not Found</h2>
        <p className="text-[#9E8F75] mb-8 max-w-md mx-auto">
        ...
        <div className="space-y-4">
          ...
          <div className="text-[#9E8F75] text-sm mt-6">
