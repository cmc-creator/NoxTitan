  ...
  return (
    <div className="min-h-screen bg-[#070604]">
      ...
      <div className="max-w-5xl mx-auto p-6">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-[#9E8F75] text-lg">Manage your information and preferences</p>
            </div>
            {!isEditing && (
              <button
        ...
        {/* Profile Card */}
        <div className="lux-card/80 rounded p-8 border-2 border-[rgba(201,168,76,0.22)] mb-6">
          {/* Avatar Section */}
          <div className="flex items-start gap-8 mb-8 pb-8 border-b border-[rgba(201,168,76,0.22)]">
            <div className="relative">
              <div className="w-32 h-32 bg-[rgba(201,168,76,0.15)] hover:bg-[rgba(201,168,76,0.22)] border border-[rgba(201,168,76,0.45)] rounded-full flex items-center justify-center text-white text-5xl font-bold">
            ...
            <div className="flex-1">
              ...
              <div className="text-[#9E8F75] text-lg font-semibold mb-1">{profile.position}</div>
              <div className="text-[#9E8F75] mb-4">{profile.department}</div>
              <div className="flex items-center gap-4">
                <div className="px-4 py-2 bg-[rgba(201,168,76,0.06)] border border-[rgba(201,168,76,0.22)] rounded-lg">
                  <div className="text-[#9E8F75] text-xs">Pronouns</div>
                  <div className="text-white font-semibold">{profile.pronouns}</div>
                </div>
                <div className="px-4 py-2 bg-[#110F0B]/50 border border-amber-500/40/30 rounded-lg">
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-[#110F0B]/50 rounded-lg p-4 border border-[rgba(201,168,76,0.22)]">
                <div className="text-[#9E8F75] text-sm mb-1">Email Address</div>
                {isEditing ? (
                  <input
                    type="email"
                    value={profile.email}
                    onChange={(e) => setProfile({...profile, email: e.target.value})}
                    className="w-full bg-[rgba(201,168,76,0.04)] border border-[rgba(201,168,76,0.22)] rounded px-3 py-2 text-white"
                  />
                ) : (
              ...
              <div className="bg-[#110F0B]/50 rounded-lg p-4 border border-[rgba(201,168,76,0.22)]">
                <div className="text-[#9E8F75] text-sm mb-1">Phone Number</div>
                {isEditing ? (
                  <input
                    type="tel"
                    value={profile.phone}
              ...
              <div className="bg-[#110F0B]/50 rounded-lg p-4 border border-[rgba(201,168,76,0.22)]">
                <div className="text-[#9E8F75] text-sm mb-1">Location</div>
              ...
              <div className="bg-[#110F0B]/50 rounded-lg p-4 border border-[rgba(201,168,76,0.22)]">
                <div className="text-[#9E8F75] text-sm mb-1">Hire Date</div>
                <div className="text-white font-semibold flex items-center gap-2">
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-[#110F0B]/50 rounded-lg p-4 border border-[rgba(201,168,76,0.22)]">
                <div className="text-[#9E8F75] text-sm mb-1">Contact Name</div>
                {isEditing ? (
                  <input
                    type="text"
              ...
              <div className="bg-[#110F0B]/50 rounded-lg p-4 border border-[rgba(201,168,76,0.22)]">
                <div className="text-[#9E8F75] text-sm mb-1">Contact Phone</div>
                {isEditing ? (
                  <input
                    type="tel"
          ...
          {/* Save/Cancel Buttons */}
          {isEditing && (
            <div className="flex gap-3 justify-end pt-4 border-t border-[rgba(201,168,76,0.22)]">
              <button
                onClick={() => setIsEditing(false)}
                className="px-6 py-3 bg-[rgba(201,168,76,0.04)] hover:bg-[rgba(201,168,76,0.08)] text-white rounded-lg font-semibold transition-all flex items-center gap-2"
              >
                <X className="w-5 h-5" />
                Cancel
              </button>
