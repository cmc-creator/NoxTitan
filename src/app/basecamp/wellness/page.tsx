...
export default function WellnessHub() {
 ...
 <h1 className="text-4xl font-black text-[#C9A84C] mb-2" style={{fontFamily: "'Cormorant Garamond', serif"}}>Wellness Hub</h1>
 <p className="text-[#9E8F75] text-lg">Your health and happiness are our priority!</p>
 </div>
 ...
 <div className="bg-[rgba(201,168,76,0.06)] rounded-lg p-4 border border-amber-500/40/30">
 <div className="text-amber-400 font-semibold mb-2">Mental Health Counseling</div>
 <p className="text-[#9E8F75] text-sm mb-3">Free, confidential sessions with licensed therapists</p>
 ...
 <div className="text-[#C9A84C] font-semibold mb-2">Financial Counseling</div>
 ...
 <button className="flex-1 px-4 py-3 bg-[rgba(201,168,76,0.15)] hover:bg-[rgba(201,168,76,0.22)] border border-[rgba(201,168,76,0.45)] text-white rounded-lg font-semibold transition-all flex items-center justify-center gap-2">
 <Phone className="w-5 h-5" />
 Call Now
 </button>
 <button className="flex-1 px-4 py-3 bg-[rgba(201,168,76,0.04)] hover:bg-[rgba(201,168,76,0.08)] text-white rounded-lg font-semibold transition-all flex items-center justify-center gap-2">
 ...
 <div className="w-full bg-[rgba(201,168,76,0.04)] rounded-full h-2 mb-2">
 <div className="bg-[#110F0B] from-REMOVED-500 to-emerald-500 h-2 rounded-full" style={{ width: '71%' }} />
 </div>
 <div className="text-[#9E8F75] text-sm">🎁 Reward: $25 Amazon Gift Card</div>
 </div>
 ...
 <div className="w-full bg-[rgba(201,168,76,0.04)] rounded-full h-2 mb-2">
 <div className="bg-[rgba(201,168,76,0.08)] h-2 rounded-full" style={{ width: '75%' }} />
 </div>
 <div className="text-[#9E8F75] text-sm">🎁 Reward: Reusable Water Bottle</div>
 </div>
 ...
 <div className="text-[#C9A84C] text-sm">5 minutes of meditation daily</div>
 </div>
 <div className="text-right">
 ...
 <div className="w-full bg-[rgba(201,168,76,0.04)] rounded-full h-2 mb-2">
 <div className="bg-[rgba(201,168,76,0.08)] h-2 rounded-full" style={{ width: '60%' }} />
 </div>
 ...
 <button className="w-full px-4 py-3 bg-[rgba(201,168,76,0.15)] hover:bg-[rgba(201,168,76,0.22)] border border-[rgba(201,168,76,0.45)] text-white rounded-lg font-semibold transition-all">
 View Membership
 </button>
 </div>
 ...
 <button className="w-full p-3 bg-[#110F0B]/50 hover:bg-[#110F0B] rounded-lg transition-all text-left border border-[rgba(201,168,76,0.22)]">
 ...
 <div className="text-[#C9A84C] font-semibold text-sm mb-1">Yoga Session</div>
 <div className="text-[#9E8F75] text-xs">Wednesday, 12:00 PM</div>
 </div>
 <div className="bg-[#110F0B]/50 rounded-lg p-3 border border-amber-500/40/20">
 <div className="text-[#C9A84C] font-semibold text-sm mb-1">Mental Health Workshop</div>
 <div className="text-[#9E8F75] text-xs">Friday, 2:00 PM</div>
 </div>
 <div className="bg-[#110F0B]/50 rounded-lg p-3 border border-amber-500/40/20">
 <div className="text-[#C9A84C] font-semibold text-sm mb-1">Team Hiking Trip</div>
 <div className="text-[#9E8F75] text-xs">Saturday, 9:00 AM</div>
 </div>
 </div>
 </div>
 </div>
