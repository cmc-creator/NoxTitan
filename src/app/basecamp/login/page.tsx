      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-gradient-to-br from-slate-800/80 to-emerald-900/30 backdrop-blur-xl rounded p-8 border-2 border-emerald-500/30 shadow-2xl">
          ...
          <div className="space-y-3">
            <button className="w-full bg-stone-950 hover:bg-[rgba(201,168,76,0.06)] text-stone-200 font-semibold py-3 rounded-lg transition-all flex items-center justify-center gap-2">
