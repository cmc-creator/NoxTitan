      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          ...
          <div className="bg-[rgba(201,168,76,0.04)] rounded p-6 border-2 border-amber-500/40/30">
            ...
            <div className="text-[#F0EBE0]/70">Gym membership & EAP</div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1">
            <div className="bg-[rgba(201,168,76,0.06)]/50 rounded p-4 border-2 border-[rgba(201,168,76,0.22)] sticky top-24">
                ...
                <button
                  ...
                  className={`w-full flex items-center gap-3 p-3 rounded-lg transition-all ${
                    selectedPlan === 'medical'
                      ...
                      : 'bg-[#110F0B]/50 text-[#9E8F75] hover:bg-[#110F0B]'
                  }`}
                >
                ...
                <div className="lux-card/80 rounded p-6 border-2 border-amber-500/40/30">
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      ...
                      <p className="text-[#9E8F75]">Comprehensive health coverage for you and your family</p>
                    </div>
                  ...
                  {/* Current Plan */}
                  <div className="bg-[rgba(201,168,76,0.06)] rounded-lg p-5 border border-amber-500/40/30 mb-6">
                    ...
                    <div className="grid grid-cols-3 gap-4 text-center">
                      <div>
                        <div className="text-[#9E8F75] text-sm">Monthly Premium</div>
                        <div className="text-white font-bold text-lg">$89</div>
                      </div>
                      <div>
                        <div className="text-[#9E8F75] text-sm">Deductible</div>
                        <div className="text-white font-bold text-lg">$1,000</div>
                      </div>
                      <div>
                        <div className="text-[#9E8F75] text-sm">Out-of-Pocket Max</div>
                  ...
                  <div className="mt-6 flex gap-3">
                    <button className="flex-1 px-4 py-3 bg-[rgba(201,168,76,0.15)] hover:bg-[rgba(201,168,76,0.22)] border border-[rgba(201,168,76,0.45)] text-white rounded-lg font-semibold transition-all">
                      Find a Doctor
                    </button>
              ...
              <div className="lux-card/80 rounded p-6 border-2 border-[rgba(201,168,76,0.22)]">
                ...
                <div className="bg-[#110F0B] from-REMOVED-900/40 to-emerald-900/40 rounded-lg p-6 border border-[rgba(201,168,76,0.22)] mb-6">
                  ...
                  <div className="grid grid-cols-3 gap-4 pt-6 border-t border-[rgba(201,168,76,0.22)]">
                    ...
                    <div className="text-center">
                      <div className="text-[#9E8F75] text-sm">Company Match</div>
                      <div className="text-white font-bold text-lg">$385/mo</div>
                    </div>
                    <div className="text-center">
                      <div className="text-[#9E8F75] text-sm">Total Monthly</div>
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div className="bg-[#110F0B]/50 rounded-lg p-4 border border-[rgba(201,168,76,0.22)]">
                    ...
                    <div className="text-[#9E8F75] text-sm">70% allocation</div>
                  </div>
                  <div className="bg-[#110F0B]/50 rounded-lg p-4 border border-[rgba(201,168,76,0.22)]">
                    <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="text-[#9E8F75] text-sm">20% allocation</div>
                  </div>
                  <div className="bg-[#110F0B]/50 rounded-lg p-4 border border-[rgba(201,168,76,0.22)]">
                    <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="text-[#9E8F75] text-sm">10% allocation</div>
                  </div>
                </div>
        ...
        {/* Quick Links */}
        <div className="mt-8 bg-[rgba(201,168,76,0.04)] rounded p-6 border-2 border-amber-500/40/30">
          <h3 className="text-xl font-bold text-white mb-4">Quick Actions</h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <button className="bg-[#110F0B]/50 hover:bg-[#110F0B] p-4 rounded-lg transition-all text-left border border-amber-500/40/20">
