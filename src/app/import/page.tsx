      ...
      <div className="max-w-7xl mx-auto">
                ...
                <div key={step.id} className="flex items-center flex-1">
                  <div className="flex flex-col items-center flex-1">
                    <div className={`w-12 h-12 rounded-full flex items-center justify-center border-2 transition-all ${
                      ...
                      'bg-[rgba(201,168,76,0.04)] border-[rgba(201,168,76,0.22)] text-[#9E8F75]'
                    }`}>
                      {isCompleted ? <Check className="w-6 h-6" /> : <Icon className="w-6 h-6" />}
                    </div>
                    <span className={`mt-2 text-sm font-semibold ${isActive ? 'text-amber-400' : isCompleted ? 'text-[#C9A84C] 400' : 'text-[#9E8F75]'}`}>
                      {step.label}
                    </span>
                  </div>
                  {index < 4 && (
                    <div className={`flex-1 h-0.5 ${isCompleted ? 'bg-[#C9A84C]' : 'bg-[#110F0B]'}`} />
                  )}
                </div>
              );
            })}
          ...
          <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="bg-[rgba(201,168,76,0.06)]/50 rounded-lg p-3">
                      ...
                      <div className="text-xs text-[#9E8F75]">Integrations</div>
                    </div>
                    <div className="bg-[rgba(201,168,76,0.06)]/50 rounded-lg p-3">
                      <div className="text-2xl font-bold text-amber-400">5 min</div>
                      <div className="text-xs text-[#9E8F75]">Avg Import Time</div>
                    </div>
                    <div className="bg-[rgba(201,168,76,0.06)]/50 rounded-lg p-3">
            ...
            <div className="grid grid-cols-2 gap-4">
              <button
                ...
                className={`p-6 rounded border-2 transition-all ${
                  importMethod === 'file' 
                    ...
                    : 'border-[rgba(201,168,76,0.22)] bg-[rgba(201,168,76,0.06)]/30 hover:border-[rgba(201,168,76,0.22)]'
                }`}
              >
                <FileSpreadsheet className="w-12 h-12 text-amber-400 mb-3" />
                <h3 className="text-xl font-bold text-white mb-2">Upload File</h3>
                <p className="text-sm text-[#9E8F75]">Import from CSV, Excel, or other file formats</p>
              </button>
              <button
              ...
              >
                ...
                <p className="text-sm text-[#9E8F75]">Connect directly to your existing software</p>
              </button>
            </div>
                ...
                {importTemplates.map((template) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <p className="text-sm text-[#9E8F75] mb-3">{template.description}</p>
              ...
              <div className="p-6 rounded" style={{ background: 'var(--card-bg)' }}>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3">
                  {selectedTemplateData.compatibleWith.map((system) => (
                    <div key={system} className="p-3 bg-[rgba(201,168,76,0.06)]/30 rounded-lg text-center hover:bg-[rgba(201,168,76,0.06)]/50 transition-all cursor-pointer">
            ...
            {selectedTemplate && (
              <button
                ...
                className="w-full py-4 bg-[rgba(201,168,76,0.15)] hover:bg-[rgba(201,168,76,0.22)] border border-[rgba(201,168,76,0.45)] text-white rounded font-bold text-lg transition-all flex items-center justify-center gap-2"
              >
                Continue to Upload
          ...
          <div className="space-y-6">
            ...
            <div className="p-6 rounded" style={{ background: 'var(--card-bg)' }}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <button className="p-4 bg-[rgba(201,168,76,0.06)]/30 rounded-lg hover:bg-[rgba(201,168,76,0.06)]/50 transition-all text-left">
                  <FileSpreadsheet className="w-8 h-8 text-[#C9A84C] 400 mb-2" />
                  <div className="font-semibold text-white">Employee Template</div>
                  <div className="text-xs text-[#9E8F75]">CSV format with sample data</div>
                </button>
                <button className="p-4 bg-[rgba(201,168,76,0.06)]/30 rounded-lg hover:bg-[rgba(201,168,76,0.06)]/50 transition-all text-left">
                  ...
                  <div key={index} className={`p-4 rounded-lg flex items-center justify-between ${
                    ...
                    <div className="flex items-center gap-4 flex-1">
                      <div className="flex-1">
                        <div className="text-sm text-[#9E8F75]">Their Field</div>
                        <div className="font-semibold text-white">{map.theirField}</div>
                      </div>
                      <ArrowRight className="w-5 h-5 text-[#9E8F75]" />
                      <div className="flex-1">
                        <div className="text-sm text-[#9E8F75]">NyxTitan Field</div>
                        {map.ourField ? (
                          <div className="font-semibold text-white">{map.ourField}</div>
                        ) : (
                          <select className="w-full px-3 py-2 bg-[rgba(201,168,76,0.04)] border border-[rgba(201,168,76,0.22)] rounded text-white">
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="p-4 rounded bg-[#110F0B] 500/20 border border-[rgba(201,168,76,0.22)] 500/50">
                ...
                <div className="text-sm text-[#9E8F75]">Errors</div>
              </div>
            </div>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-[rgba(201,168,76,0.22)]">
                      <th className="text-left py-3 px-4 text-[#9E8F75] font-semibold">Status</th>
                      <th className="text-left py-3 px-4 text-[#9E8F75] font-semibold">First Name</th>
                      <th className="text-left py-3 px-4 text-[#9E8F75] font-semibold">Last Name</th>
                      <th className="text-left py-3 px-4 text-[#9E8F75] font-semibold">Email</th>
                      <th className="text-left py-3 px-4 text-[#9E8F75] font-semibold">Department</th>
                      <th className="text-left py-3 px-4 text-[#9E8F75] font-semibold">Role</th>
                      <th className="text-left py-3 px-4 text-[#9E8F75] font-semibold">Pay Rate</th>
                    </tr>
                  </thead>
                  <tbody>
            ...
            <div className="flex gap-4">
              <button className="flex-1 py-4 bg-[rgba(201,168,76,0.04)] hover:bg-[rgba(201,168,76,0.08)] text-white rounded font-bold text-lg transition-all">
                Fix Errors First
              </button>
              <button
                onClick={() => setActiveStep('complete')}
                className="flex-1 py-4 bg-[#110F0B] from-REMOVED-600 to-amber-800 hover:from-[#110F0B] 700 text-white rounded font-bold text-lg transition-all flex items-center justify-center gap-2"
              >
                Import Data Now
        ...
        {activeStep === 'complete' && (
          <div className="text-center py-12">
            ...
            <p className="text-xl text-[#9E8F75] mb-8">Successfully imported 122 employee records</p>
            ...
            <div className="grid grid-cols-3 gap-4 max-w-2xl mx-auto mb-8">
              ...
              <div className="p-6 rounded bg-amber-600/20 border border-amber-500/40/50">
                ...
                <div className="text-sm text-[#9E8F75]">Time Taken</div>
              </div>
            ...
            <div className="flex gap-4 justify-center">
              <button
                ...
                className="px-8 py-3 bg-[rgba(201,168,76,0.04)] hover:bg-[rgba(201,168,76,0.08)] text-white rounded font-semibold transition-all"
              >
                Import More Data
              </button>
              <button className="px-8 py-3 bg-[rgba(201,168,76,0.15)] hover:bg-[rgba(201,168,76,0.22)] border border-[rgba(201,168,76,0.45)] text-white rounded font-semibold transition-all">
                View Imported Data
              </button>
            </div>
          </div>
