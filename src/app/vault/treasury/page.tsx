...
export default function TreasuryPage() {
 ...
 className="bg-[rgba(201,168,76,0.06)]/50 border border-[rgba(201,168,76,0.22)] rounded p-6 hover:border-[rgba(201,168,76,0.45)] cursor-pointer transition-all"
 >
 ...
 <div>
 <div className="bg-[rgba(201,168,76,0.06)]/50 border border-amber-500/40 rounded p-4 mb-6">
 <div className="flex items-center justify-between">
 <div>
 ...
 <div>
 <div className="bg-[rgba(201,168,76,0.06)]/50 border border-amber-500/40 rounded p-6 mb-6">
