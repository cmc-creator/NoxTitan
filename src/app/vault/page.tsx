...
function AssetVaultPage() {
 ...
 {loading ? (
 <div className="col-span-full bg-[rgba(201,168,76,0.06)]/50 border border-[rgba(201,168,76,0.22)] rounded p-12 text-center">
 ...
 className="bg-[rgba(201,168,76,0.06)]/50 border border-[rgba(201,168,76,0.22)] rounded p-6 hover:border-[rgba(201,168,76,0.45)]/50 transition-all cursor-pointer group"
 >
 {/* Category Badge */}
