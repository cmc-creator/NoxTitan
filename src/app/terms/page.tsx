export default function TermsPage() {
  return (
    <div className="min-h-screen lux-app-bg p-8">
      <div className="max-w-4xl mx-auto bg-[rgba(201,168,76,0.06)]/80 rounded shadow-2xl p-12 border border-[rgba(201,168,76,0.22)]">
        <h1 className="text-4xl font-extrabold text-[#C9A84C] mb-6">Terms of Service</h1>
        <p className="text-[#9E8F75] mb-4">Effective Date: January 1, 2026</p>
        ...
        <div className="space-y-6 text-[#9E8F75]">
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#C9A84C] mb-3">2. Service Description</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#C9A84C] mb-3">3. Subscription Plans</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#C9A84C] mb-3">4. User Responsibilities</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#C9A84C] mb-3">5. Data Ownership</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#C9A84C] mb-3">6. Payment Terms</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#C9A84C] mb-3">7. Cancellation and Termination</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#C9A84C] mb-3">8. Service Availability</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#C9A84C] mb-3">10. Intellectual Property</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#C9A84C] mb-3">11. Modifications to Terms</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#C9A84C] mb-3">12. Governing Law</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-[#C9A84C] mb-3">13. Contact Information</h2>
