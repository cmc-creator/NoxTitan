      ...
      <div className="max-w-3xl mx-auto">
        ...
        {step === 1 && (
          <div className="bg-stone-900/50 border border-stone-700 rounded p-8">
            ...
            <p className="text-stone-300 mb-6">Let's get you set up. First, what's your role?</p>
          ...
          <div className="bg-stone-900/50 border border-stone-700 rounded p-8">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-semibold text-stone-300 mb-2">First Name *</label>
                  <input
                    type="text"
                    value={data.firstName}
                    onChange={(e) => updateData('firstName', e.target.value)}
                    className="w-full px-4 py-3 bg-stone-950/50 border border-stone-700 rounded-lg text-white"
                    required
                  />
                </div>
                <div>
                  <label className="block text-sm font-semibold text-stone-300 mb-2">Last Name *</label>
                  <input
                    type="text"
                    value={data.lastName}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-3 bg-stone-950/50 border border-stone-700 rounded-lg text-white"
                    required
                  />
                </div>
              </div>
              ...
              <div>
                <label className="block text-sm font-semibold text-stone-300 mb-2">Phone</label>
                <div className="relative">
              ...
              <div>
                <label className="block text-sm font-semibold text-stone-300 mb-2">Date of Birth</label>
                <div className="relative">
            ...
            <div className="flex justify-between mt-8">
              ...
              <button
                ...
                className="px-6 py-3 bg-gradient-to-r from-amber-700 to-amber-600 hover:from-stone-900 hover:to-pink-700 text-white font-bold rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
              >
        ...
        {step === 3 && (
          <div className="bg-stone-900/50 border border-stone-700 rounded p-8">
            ...
            <div className="flex justify-between mt-8">
              ...
              <button
                onClick={() => setStep(4)}
                className="px-6 py-3 bg-gradient-to-r from-amber-700 to-amber-600 hover:from-stone-900 hover:to-pink-700 text-white font-bold rounded-lg transition-all flex items-center gap-2"
              >
                Next <ChevronRight className="w-5 h-5" />
              </button>
            </div>
        ...
        {step === 4 && (
          <div className="bg-stone-900/50 border border-stone-700 rounded p-8">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-semibold text-stone-300 mb-2">Department *</label>
                <select
              ...
              <div>
                <label className="block text-sm font-semibold text-stone-300 mb-2">Position/Title *</label>
                <input
                  type="text"
                  value={data.position}
              ...
              <div>
                <label className="block text-sm font-semibold text-stone-300 mb-2">Start Date *</label>
                <input
                  type="date"
              ...
              <div>
                <label className="block text-sm font-semibold text-stone-300 mb-2">Professional Goals</label>
                <textarea
                  value={data.goals}
        ...
        {step === 5 && data.role === 'manager' && (
          <div className="bg-stone-900/50 border border-stone-700 rounded p-8">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-semibold text-stone-300 mb-2">Team Size</label>
                <input
                  type="number"
                  value={data.teamSize || ''}
              ...
              <div>
                <label className="block text-sm font-semibold text-stone-300 mb-2">Management Style</label>
                <textarea
              ...
              <div>
                <label className="block text-sm font-semibold text-stone-300 mb-2">Leadership Goals</label>
                <textarea
