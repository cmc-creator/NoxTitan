...
- Inventory and asset tracking sheets

## User Actions
- Browse, search, and filter templates
- Customize and brand documents
- Upload new templates/forms
- Download, print, and e-sign documents
- Assign forms to teams or individuals
- Track usage and acknowledgments
